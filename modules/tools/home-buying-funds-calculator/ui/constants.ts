...
export const FIELD_TOOLTIPS = {
  ...
  isOver85m2:
    '전용면적 85㎡ 초과 여부에 따라 농어촌특별세 면제가 달라집니다.\n\n[법적 기준] 「농어촌특별세법」 제4조제11호·시행령 제4조제5항은 전용면적 85㎡ 이하(국민주택규모) 주택이면 매매가·주택 수와 무관하게 비과세로 정합니다.\n\n[이 계산기의 제한] 계산기는 여기에 6억 이하·무주택 또는 1주택 조건을 추가로 걸어 비과세 여부를 판단합니다. 이는 법령이 아니라 계산기가 보수적으로 덧붙인 조건이라, 85㎡ 이하이면서 6억 초과이거나 2주택 이상이면 계산기가 실제로는 비과세인 경우를 과세로 계산할 수 있습니다.\n\n[영향 항목: 농어촌특별세]\n• 85㎡ 초과: 취득세의 10% 부과\n\n(예: 5억 주택, 1주택 기준)\n• 85㎡ 이하: 0원 (면제)\n• 85㎡ 초과: 50만원 (취득세 500만원의 10%)',
  isFirstTime:
