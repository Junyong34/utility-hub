...
export const FIELD_TOOLTIPS = {
  ...
  houseCount:
    '현재 보유 주택 수에 따라 취득세율이 달라집니다.\n\n[영향 항목: 취득세]\n• 1주택: 6억 이하 1%, 6~9억 보간세율, 9억 초과 3%\n• 2주택(비조정): 1%\n• 2주택(조정): 8%\n• 3주택(비조정): 3%\n• 3주택(조정): 12%\n\n(예: 5억 주택 기준)\n• 1주택: 500만원\n• 2주택 조정지역: 4,000만원\n• 3주택 조정지역: 6,000만원',
  isOver85m2:
    '전용면적 85㎡ 초과 여부에 따라 농어촌특별세 면제가 달라집니다.\n\n[영향 항목: 농어촌특별세]\n• 85㎡ 이하 + 1주택 + 6억 이하: 면제\n• 85㎡ 초과: 취득세의 10% 부과\n\n(예: 5억 주택, 1주택 기준)\n• 85㎡ 이하: 0원 (면제)\n• 85㎡ 초과: 50만원 (취득세 500만원의 10%)',
  isFirstTime:
    '생애최초 주택 구입 시 취득세 감면이 적용됩니다.\n\n[영향 항목: 취득세]\n[근거] 2026-08-03 기준 「지방세특례제한법」 제36조의3\n[조건] 무주택자, 취득당시가액 12억원 이하 (전용면적 요건 없음)\n• 산출세액 200만원 이하: 전액 면제\n• 산출세액 200만원 초과: 산출세액에서 200만원 공제\n\n(예: 5억 주택 기준)\n• 일반 1주택 산출세액: 500만원\n• 생애최초 특례: 300만원 (200만원 절감)\n\n※ 전용 60㎡ 이하 공동주택·도시형생활주택·다가구주택·인구감소지역 주택은 300만원 한도가 적용되어 실제 감면이 이보다 더 클 수 있습니다(이 계산기는 해당 유형을 구분하지 않습니다).',
  isTempTwoHouse:
  ...
  contingencyRatio:
    '예상치 못한 비용에 대비한 예비비 비율입니다. 3~10% 권장합니다.',
} as const;
