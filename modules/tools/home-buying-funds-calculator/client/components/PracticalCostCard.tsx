...
} from '../practical-cost-inputs';
import { ARIA_LABELS, FIELD_LABELS, PRESET_LABELS } from '../../ui';
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={value => {
              const updates: Partial<HomeBuyingInput> = {
                brokerageFeePreset: value as 'auto' | 'manual',
              };
              if (
                value === 'manual' &&
                input.manualBrokerageFee === undefined
              ) {
          ...
          >
            <SelectTrigger
              ...
              aria-label={ARIA_LABELS.brokerageFeePresetSelect}
            >
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="auto">
                {PRESET_LABELS.brokerageFee.auto}
              </SelectItem>
              <SelectItem value="manual">
                {PRESET_LABELS.brokerageFee.manual}
              </SelectItem>
            </SelectContent>
          </Select>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={value => {
              const updates: Partial<HomeBuyingInput> = {
                lawyerFeePreset: value as 'auto' | 'manual',
              };
          ...
          >
            <SelectTrigger
              className="w-full max-w-[200px]"
              aria-label={ARIA_LABELS.lawyerFeePresetSelect}
            >
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="auto">
                {PRESET_LABELS.lawyerFee.auto}
              </SelectItem>
              <SelectItem value="manual">
                {PRESET_LABELS.lawyerFee.manual}
              </SelectItem>
            </SelectContent>
          </Select>
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger
              className="w-full max-w-[200px]"
              aria-label={ARIA_LABELS.cleaningFeePresetSelect}
            >
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="none">
                {PRESET_LABELS.cleaningFee.none}
              </SelectItem>
              <SelectItem value="basic">
                {PRESET_LABELS.cleaningFee.basic}
              </SelectItem>
              <SelectItem value="premium">
                {PRESET_LABELS.cleaningFee.premium}
              </SelectItem>
              <SelectItem value="manual">
                {PRESET_LABELS.cleaningFee.manual}
              </SelectItem>
            </SelectContent>
          </Select>
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger
              className="w-full max-w-[200px]"
              aria-label={ARIA_LABELS.movingFeePresetSelect}
            >
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="small">
                {PRESET_LABELS.movingFee.small}
              </SelectItem>
              <SelectItem value="medium">
                {PRESET_LABELS.movingFee.medium}
              </SelectItem>
              <SelectItem value="large">
                {PRESET_LABELS.movingFee.large}
              </SelectItem>
              <SelectItem value="manual">
                {PRESET_LABELS.movingFee.manual}
              </SelectItem>
            </SelectContent>
          </Select>
        ...
        <div className="space-y-2">
          ...
          >
            <SelectTrigger
              className="w-full max-w-[200px]"
              aria-label={ARIA_LABELS.interiorFeePresetSelect}
            >
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="none">
                {PRESET_LABELS.interiorFee.none}
              </SelectItem>
              <SelectItem value="basic">
                {PRESET_LABELS.interiorFee.basic}
              </SelectItem>
              <SelectItem value="standard">
                {PRESET_LABELS.interiorFee.standard}
              </SelectItem>
              <SelectItem value="premium">
                {PRESET_LABELS.interiorFee.premium}
              </SelectItem>
              <SelectItem value="manual">
                {PRESET_LABELS.interiorFee.manual}
              </SelectItem>
            </SelectContent>
          </Select>
        ...
        <div className="space-y-2">
          <Label
            htmlFor="manualManagementDeposit"
