          ...
          <AlertDialogDescription className="w-full space-y-4 text-left leading-6">
            ...
            <div>
              ...
              <ul className="mt-2 space-y-1.5 text-sm">
                <li>
                  • <strong>서울</strong>: 5,500만원
                </li>
                <li>
                  • <strong>과밀억제권역</strong> (성남, 고양, 과천 등):
                  5,000만원
                </li>
                <li>
                  • <strong>광역시</strong> (부산, 대구, 대전 등): 2,800만원
                </li>
                <li>
                  • <strong>기타 지방</strong>: 2,000만원
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="mt-2 rounded-md bg-muted p-3 text-sm">
                <p>
                  <strong>아파트 가격</strong>: 5억원
                </p>
                <p>
                  <strong>LTV 70%</strong> → 이론상 3.5억 대출 가능
                </p>
                <p className="mt-2 text-primary">
                  <strong>서울 기준</strong>: 3.5억 - 5,500만원 ={' '}
                  <strong>실제 대출 2.95억</strong>
                </p>
