...
import { MovingBudgetInputSection } from './MovingBudgetInputSection';
import { MovingBudgetResultSection } from './MovingBudgetResultSection';
import { useMovingBudgetChecklist } from './useMovingBudgetChecklist';
      ...
      <main className="mx-auto max-w-7xl space-y-6 px-4 pb-16 sm:px-6 lg:px-8">
        <section className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            자산, 매매 비용, 입주 전 부대비용, 입주 시 가전·가구 비용을 한
            화면에서 정리하고 체크리스트 진행 상황까지 같이 봅니다.
          </p>
        </section>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm text-muted-foreground">
            <p>
              체크 상태는 진행률만 바꾸고 총예상비용 계산에는 영향을 주지
              않습니다.
            </p>
            <p>
              이 페이지는 직접 URL로 접근하는 개인용 운영 화면이며 검색 노출
              대상이 아닙니다.
            </p>
          </CardContent>
        </Card>
