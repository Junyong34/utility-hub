// nuqs/server는 React hook 없이 동일한 순수 parser builder만 제공합니다.
...
import type { InterestType, TaxType } from './savings-calculation.ts';
...
export const DEPOSIT_QUERY_PARSERS = {
  ...
  interestType: parseAsStringLiteral([
    'simple',
    'compound',
  ] as const).withDefault('simple'),
