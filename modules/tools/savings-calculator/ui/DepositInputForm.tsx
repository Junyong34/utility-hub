...
import type { InterestType, TaxType } from '../public.ts';
import { getNumberInput } from '../domain/numeric-input.ts';
import { getSelectableOptionButtonState } from './accessibility.ts';
import { INTEREST_TYPES, TAX_TYPES } from './constants.ts';
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        {/* 이자 방식 */}
        <FormSectionGroup>
          <FormFieldGroup label="이자 방식" description="단리 또는 복리 선택">
              ...
              <div className="mt-4 p-4 bg-muted/30 rounded-lg border">
                ...
                <div className="flex gap-2 items-center">
                  <Input
                    ...
                    value={customTaxRate}
                    onChange={event =>
                      onCustomTaxRateChange(event.target.value)
                    }
