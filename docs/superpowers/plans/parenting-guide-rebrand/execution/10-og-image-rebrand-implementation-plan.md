...
- [ ] **Step 1: 현재 하드코딩된 다크 기본값을 분리한다**
- [ ] **Step 2: 육아형 팔레트 토큰과 프리셋 이름을 정의한다**
- [ ] **Step 3: `play-card`, `tool-card`, `custom-studio` 레이아웃 변형을 분리한다**
- [ ] **Step 4: `createOgImageResponse`가 레이아웃/테마 옵션을 받을 수 있게 확장한다**
...
- [ ] **Step 1: 블로그 OG 3개, 도구 OG 3개, custom OG 3개를 샘플 렌더링한다**
- [ ] **Step 2: 라이트 배경에서 제목 대비가 충분한지 확인한다**
- [ ] **Step 3: 마스코트 on/off, 이미지 on/off, 라벨 길이 차이를 확인한다**
- [ ] **Step 4: `lib/seo/og.test.mjs`를 보완하거나 새 테스트를 추가한다**
