...
- Read: `docs/superpowers/specs/2026-06-30-baby-fruit-intake-research-design.md`
...
```bash
sed -n '1,220p' docs/superpowers/specs/2026-06-30-baby-fruit-intake-research-design.md
```
