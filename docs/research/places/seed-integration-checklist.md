...
| gyeonggi-north-local-kids-cafes-semi-verified.md | 키키키즈풀                                                 | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-north-local-kids-cafes-semi-verified.md | 인더풀                                                     | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-north-local-kids-cafes-semi-verified.md | 상상키즈룸 파주운정점                                      | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-north-outing-facilities.md              | 경기북부어린이박물관                                       | 신규 추가 완료 | 경기북부어린이박물관                  | content/places에 신규 seed 추가 + 네이버 지도 링크 반영 완료 |
...
| gyeonggi-south-baby-cafes.md                     | 안양시 아이러브맘카페                                      | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-family-friendly-cafes.md          | 더그림                                                     | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-family-friendly-cafes.md          | 무이숲                                                     | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-family-friendly-cafes.md          | IKEA 광명 스웨디시 카페                                    | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-family-friendly-cafes.md          | IKEA 기흥 스웨디시 카페                                    | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-family-friendly-cafes.md          | 아쿠아필드 안성 카페 드 아쿠아                             | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-local-kids-cafes-semi-verified.md | 모넬로 키즈카페 시흥능곡역점                               | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-local-kids-cafes-semi-verified.md | 꿀잼키즈룸 안산중앙점                                      | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-local-kids-cafes-semi-verified.md | 리틀퐁당                                                   | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-local-kids-cafes-semi-verified.md | Bundle of Joy 토들러카페 광명본점                          | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-local-kids-cafes-semi-verified.md | 펀플리 프라이빗 키즈&파티룸                                | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-local-kids-cafes-semi-verified.md | 별숲 키즈룸                                                | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-outing-facilities.md              | 경기도어린이박물관                                         | 기존 반영      | 경기도어린이박물관                    | 이번 차수 이전부터 seed에 반영됨                             |
| gyeonggi-south-outing-facilities.md              | 국립과천과학관 유아체험관                                  | 기존 보강 완료 | 국립과천과학관                        | 기존 seed `국립과천과학관`에 어린이 전용 공간 정보 통합      |
| gyeonggi-south-outing-facilities.md              | 용인어린이상상의숲                                         | 신규 추가 완료 | 용인어린이상상의숲                    | content/places에 신규 seed 추가 + 네이버 지도 링크 반영 완료 |
| gyeonggi-south-outing-facilities.md              | 한국잡월드 어린이체험관                                    | 신규 추가 완료 | 한국잡월드 어린이체험관               | content/places에 신규 seed 추가 + 네이버 지도 링크 반영 완료 |
| gyeonggi-south-outing-facilities.md              | 아쿠아플라넷 광교                                          | 신규 추가 완료 | 아쿠아플라넷 광교                     | content/places에 신규 seed 추가 + 네이버 지도 링크 반영 완료 |
| gyeonggi-south-outing-facilities.md              | 철도박물관                                                 | 신규 추가 완료 | 철도박물관                            | content/places에 신규 seed 추가 + 네이버 지도 링크 반영 완료 |
| gyeonggi-south-outing-facilities.md              | 광명동굴                                                   | 신규 추가 완료 | 광명동굴                              | content/places에 신규 seed 추가 + 썸네일 연결 완료           |
| gyeonggi-south-private-kids-cafes.md             | IKEA Småland 광명점                                        | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-private-kids-cafes.md             | IKEA Småland 기흥점                                        | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-private-kids-cafes.md             | 챔피언 더 블랙벨트 스타필드 시티 부천                      | 신규 추가 완료 | 챔피언 더 블랙벨트 스타필드 시티 부천 | content/places에 신규 seed 추가 + 썸네일 연결 완료           |
| gyeonggi-south-private-kids-cafes.md             | 챔피언 더 블랙벨트 스타필드 수원                           | 신규 추가 완료 | 챔피언 더 블랙벨트 스타필드 수원      | content/places에 신규 seed 추가 + 썸네일 연결 완료           |
| gyeonggi-south-private-kids-cafes.md             | 별마당 키즈 스타필드 시티 부천                             | 미반영         | -                                     | 이번 차수 미반영                                             |
| gyeonggi-south-private-kids-cafes.md             | 별마당 키즈 스타필드 수원                                  | 신규 추가 완료 | 별마당 키즈 스타필드 수원             | content/places에 신규 seed 추가 + 썸네일 연결 완료           |
...
| seoul-local-kids-cafes-semi-verified.md          | 뚜뚜랑놀자                                                 | 미반영         | -                                     | 이번 차수 미반영                                             |
| seoul-local-kids-cafes-semi-verified.md          | 착한토끼 서대문북아현하우스                                | 미반영         | -                                     | 이번 차수 미반영                                             |
| seoul-local-kids-cafes-semi-verified.md          | 카라플레이                                                 | 미반영         | -                                     | 이번 차수 미반영                                             |
| seoul-local-kids-cafes-semi-verified.md          | 우리끼리 키즈카페 스포츠마을 답십리점                      | 미반영         | -                                     | 이번 차수 미반영                                             |
| seoul-outing-facilities.md                       | 서울상상나라                                               | 신규 추가 완료 | 서울상상나라                          | content/places에 신규 seed 추가 + 네이버 지도 링크 반영 완료 |
| seoul-outing-facilities.md                       | 국립민속박물관 어린이박물관                                | 기존 보강 완료 | 국립민속박물관                        | 기존 seed `국립민속박물관`에 어린이 전용 공간 정보 통합      |
| seoul-outing-facilities.md                       | 국립중앙박물관 어린이박물관                                | 기존 보강 완료 | 국립중앙박물관                        | 기존 seed `국립중앙박물관`에 어린이 전용 공간 정보 통합      |
| seoul-outing-facilities.md                       | 국립어린이과학관                                           | 신규 추가 완료 | 국립어린이과학관                      | content/places에 신규 seed 추가 + 네이버 지도 링크 반영 완료 |
