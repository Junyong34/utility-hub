...
export const SEOUL_PLACES = [
  ...
  },
  {
    ...
    verificationStatus: 'official_verified',
    description:
      '경복궁 내에 위치한 국립 민속박물관. 어린이박물관 별도 운영. 한국 생활문화 체험.',
    address: '서울 종로구 삼청로 37',
    operatingHours: '09:00-18:00 (화요일 휴관, 계절별 연장)',
    priceInfo: '무료',
    feedingRoom: true,
    strollerFriendly: true,
    rainFriendly: true,
  ...
  },
  {
    ...
    parking: true,
    sourceType: 'official',
    sourceUrl: 'https://www.sciencecenter.go.kr/',
    naverMapUrl: 'https://map.naver.com/p/entry/place/12965666',
    verifiedAt: '2026-04-01',
    lastObservedAt: '2026-04-01',
    verificationStatus: 'official_verified',
    description:
      '과학 체험과 천문 관측이 가능한 국립 과학 박물관. 야외 공원과 실내 전시 모두 운영.',
    address: '경기 과천시 상하벌로 110',
    operatingHours: '09:30-17:30 (월요일 휴관)',
    priceInfo: '어린이 1,000원, 청소년 1,500원, 성인 4,000원',
    feedingRoom: true,
    strollerFriendly: true,
    rainFriendly: true,
    stayMinutes: 150,
    operatorType: 'public',
    editorNote: '수도권 접근성 좋음. 과천 위치이나 서울 생활권으로 분류',
  ...
  },
  {
    ...
    verificationStatus: 'official_verified',
    description:
      '국내 최대 규모의 국립박물관. 어린이 전용 박물관과 교육 프로그램을 운영합니다.',
    address: '서울 용산구 서빙고로 137',
    operatingHours: '10:00-18:00 (수·토 21:00까지, 월요일 휴관)',
    priceInfo: '상설전시 무료, 특별전 유료',
    feedingRoom: true,
    strollerFriendly: true,
    rainFriendly: true,
    stayMinutes: 120,
    operatorType: 'public',
    thumbnailImage: '/images/places/seoul-national-museum-of-korea.jpg',
  },
  {
