        ...
        {NAV_ITEMS.map(item => {
          ...
          return (
            ...
            >
              ...
              <Icon
                className={`h-5 w-5 relative z-10 transition-colors duration-300 ${isActive ? 'stroke-primary stroke-[2.5]' : ''}`}
              />
              <span className="text-[9px] font-medium leading-tight relative z-10">
                {item.name}
              </span>
            </Link>
          );
