  ...
  return (
    <footer className="border-t border-border/40 bg-muted/20 mt-16">
      <div className="max-w-screen-xl mx-auto px-4 py-10">
        ...
        {/* 하단 카피라이트 */}
        <div className="mt-8 pt-6 border-t border-border/30 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <p className="text-xs text-muted-foreground">
            © {year} Zento. All rights reserved.
          </p>
          <p className="text-xs text-muted-foreground">
            정보 오류나 제안은{" "}
            <Link href="/faq" className="hover:text-foreground transition-colors underline underline-offset-2">
              FAQ
            </Link>
            에서 확인하세요.
          </p>
